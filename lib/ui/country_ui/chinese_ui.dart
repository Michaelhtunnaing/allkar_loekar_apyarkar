import 'package:allkar_loekar_apyarkar/controller/chinese_controller.dart';
import 'package:allkar_loekar_apyarkar/ui/data_viewall.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class ChineseUi extends GetView<ChineseController> {
  const ChineseUi({super.key});
        ...
        child: Obx(() {
          ...
          if (controller.errorMessage.isNotEmpty) {
            ...
            return GridView.builder(
                ...
                itemCount: controller.chineseData.length,
                itemBuilder: (context, index) {
                  String title = controller.chineseData[index].title;
                  String img = controller.chineseData[index].img;
                  List list = controller.chineseData[index].movie;
                  return Column(
                    children: [
                      GestureDetector(
                        child: ClipRRect(
